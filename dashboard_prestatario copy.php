...
$prestatarios = $result->fetch_all(MYSQLI_ASSOC);
?>
...
<body>
        ...
        <div class="row">
            <div class="col-md-12 center-table"> <!-- Utiliza la clase center-table para centrar la tabla -->
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($prestatarios as $prestatario) : if ($prestatario['state'] == 0) continue; ?>
                            <tr>
                                <td><?php echo $prestatario['borrower_id']; ?></td>
                                <td><?php echo $prestatario['username']; ?></td>
                                <td><?php echo $prestatario['email']; ?></td>
                                <td><?php echo $prestatario["district_name"]; ?></td>
                                <td><?php echo $prestatario["province_name"]; ?></td>
                                <td><?php echo $prestatario["department_name"]; ?></td>
                                <td>
                                    <a href="#" onclick="obtenerPrestatario('<?= $prestatario['borrower_id']; ?>')" data-toggle="modal" data-target="#editarPrestatario" class="btn btn-primary btn-sm">Editar</a>
                                    <a href="#" onclick="eliminaPrestatario('<?= $prestatario['borrower_id']; ?>')" class="btn btn-danger btn-sm">Eliminar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <!-- Modal -->
    <div class="modal fade" id="editarPrestatario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
