...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO prestamista (leader_id, username, password, email) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("isss", $leader_id, $username, $password, $email);
    $stmt->execute();
...
<body>
    ...
    ?>
     <br>
    <a href="dashboard_jefe.php">Volver al Dashboard</a>
</body>
</html>
